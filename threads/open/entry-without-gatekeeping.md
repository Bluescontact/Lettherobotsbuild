# Thread: Entry Without Gatekeeping

## The Question
The recognition infrastructure uses graduated trust: you don't start with full access. You demonstrate coherent action in shared stakes over time. Trust is earned through observable behavior, not claimed through credentials.

But graduated trust has a shadow: gatekeeping. Every entry barrier, however well-intentioned, can become a mechanism of exclusion. The people who design the entry sequence hold structural power over who gets in. The question: how does graduated trust entry avoid becoming the thing it was built to replace?

## What's Been Established

### Gatekeeping vs. graduated trust — a structural distinction
Gatekeeping filters *people* based on attributes (credentials, identity, affiliation). Graduated trust filters *behavior* based on observable coherent action. The distinction is between screening who you are and calibrating how you act. One is static, the other is developmental.
